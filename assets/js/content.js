$(function(){
    $.getJSON("./util/content.json", function(data){
        ...
        $('#edu-focus-minor').html("Focus in " + Object.values(data.biography.education)[0].focus +". Minor in "+ data.biography.education[0].minor)
        ...
        Object.values(data.skills).forEach(val => {
            ...
            skill.setAttribute('style', 'height: 64px; margin-right: 56px; text-align: left;')
            skilltext.setAttribute('style', 'font-size: 14px')
            skillicon.setAttribute('style', 'color: #23252f; line-height: 1.5')
            ...
            $("#skill-icon" + i).attr({'class': val.icon})
